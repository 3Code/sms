<html>
<head>
<title>Import Data dari File .XLS</title>
...
//             kosongkan tabel pegawai
             $truncate ="TRUNCATE TABLE tbl_pelanggan";
...
//      setelah data dibaca, masukkan ke tabel pegawai sql
      $query = "INSERT into tbl_pelanggan (idpel,namapel,alamat,tarif,daya,notelp) values('$IDPEL','$NAMAPEL','$ALAMAT','$TARIF','$DAYA','$NOTELP')";
...
?>
<br/>
<form name="myForm" id="myForm" onSubmit="return validateForm()" action="../smsGateway/importPelanggan.php" method="post" enctype="multipart/form-data" class="form-inline">
